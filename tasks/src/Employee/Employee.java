 ...
 *
 * ЗАДАНИЕ
 * Реализовать класс, представляющий собой описание сотрудника компании (Employee.Employee).
 *
 * ТРЕБОВАНИЯ
 ...
 * public class EmployeeImpl implements Employee.Employee {  }
...
public interface Employee {
     ...
     *   к полям класса EmployeeImpl. Более того, поскольку в интерфейсе Employee.Employee не объявлено
